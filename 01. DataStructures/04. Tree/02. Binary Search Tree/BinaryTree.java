...
public class BinaryTree {
    ...
    public static void main(String[] args) {
        ...
        while (flag) {
            ...
            System.out.println("20 - Delete a Node");
            System.out.println("21 - Construct BT from Pre-Order and In-Order");
            System.out.println("22 - Construct BT from Post-Order and In-Order");
            System.out.println("23 - Construct BST from In-Order");
            System.out.println("24 - Construct BST from Pre-Order");
            System.out.println("25 - Construct BST from Post-Order");
            System.out.println("26 - Check if the Binary Tree is Balanced");
